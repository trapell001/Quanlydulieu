...
@Data
public class TblTariffPlanParticipantNRTDTO {
    ...
    public TblTariffPlanParticipantNRTDTO(List<String> bic, int tariffPlanId, Date dateCreated, Date dateModified, String channelId, ChannelType channelType) {
        this.bic = bic;
        this.tariffPlanId = tariffPlanId;
        this.dateCreated = dateCreated;
        this.dateModified = dateModified;
    ...
    public TblTariffPlanParticipantNRTDTO() {
    }
}
