...
@Data
public class TblTariffPlanParticipantRTPRequestDTO {
    ...
    public TblTariffPlanParticipantRTPRequestDTO(List<String> bic, int tariffPlanId, Date dateCreated, Date dateModified, String channelId, ChannelType channelType) {
        this.bic = bic;
    ...
    public TblTariffPlanParticipantRTPRequestDTO() {
    }
}
