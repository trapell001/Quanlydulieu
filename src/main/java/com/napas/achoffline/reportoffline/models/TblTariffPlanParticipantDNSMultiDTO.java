...
@Data
public class TblTariffPlanParticipantDNSMultiDTO {
    ...
    public TblTariffPlanParticipantDNSMultiDTO(List<String> bic, int tariffPlanId, Date dateCreated, Date dateModified, String channelId, ChannelType channelType) {
        this.bic = bic;
        this.tariffPlanId = tariffPlanId;
        this.dateCreated = dateCreated;
        this.dateModified = dateModified;
    ...
    public TblTariffPlanParticipantDNSMultiDTO() {
    }
}
