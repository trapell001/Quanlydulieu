...
@Data
public class TblTariffPlanParticipantDNSMultiRequestDTO {
    ...
    public TblTariffPlanParticipantDNSMultiRequestDTO(List<String> bic, int tariffPlanId, Date dateCreated, Date dateModified, String channelId, ChannelType channelType) {
        this.bic = bic;
    ...
    public TblTariffPlanParticipantDNSMultiRequestDTO() {
    }
}
