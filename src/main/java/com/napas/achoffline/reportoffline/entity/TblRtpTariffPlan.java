 ...
 */
@Entity
@Table(name = "TBL_RTP_TARIFF_PLAN")
@NamedQueries({
        @NamedQuery(name = "TblRtpTariffPlan.findAll", query = "SELECT t FROM TblRtpTariffPlan t")})
public class TblRtpTariffPlan implements Serializable {
    ...
    public TblRtpTariffPlan() {
    }

    public TblRtpTariffPlan(Integer tariffPlanId) {
        this.tariffPlanId = tariffPlanId;
    }

    public TblRtpTariffPlan(String planName, String planDescription, long ladderEnabledAmount, ReturnPaymentFeeType returnPaymentFeeType, Integer tariffPlanId, Date dateCreate, Date dateModified, String tariffPlanCode) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TblRtpTariffPlan)) {
            return false;
        }
        TblRtpTariffPlan other = (TblRtpTariffPlan) object;
    ...
    public String toString() {
        return "com.napas.achoffline.authentication.models.TblRtpTariffPlan[ tariffPlanId=" + tariffPlanId + " ]";
    }
