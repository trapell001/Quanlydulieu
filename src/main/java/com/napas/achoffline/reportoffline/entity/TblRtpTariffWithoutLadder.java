 ...
 */
@Entity
@Table(name = "TBL_RTP_TARIFF_WITHOUT_LADDER")
@NamedQueries({
        @NamedQuery(name = "TblRtpTariffWithoutLadder.findAll", query = "SELECT t FROM TblRtpTariffWithoutLadder t")})
public class TblRtpTariffWithoutLadder implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TblRtpTariffWithoutLadder)) {
            return false;
        }
        TblRtpTariffWithoutLadder other = (TblRtpTariffWithoutLadder) object;
    ...
    public String toString() {
        return "com.napas.achoffline.authentication.entity.TblRtpTariffWithoutLadder[ tariffId=" + tariffId + " ]";
    }
