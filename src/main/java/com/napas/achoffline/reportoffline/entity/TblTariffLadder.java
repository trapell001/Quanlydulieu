 ...
 */
@Entity
@Table(name = "TBL_TARIFF_LADDER")
@NamedQueries({
    @NamedQuery(name = "TblTariffLadder.findAll", query = "SELECT t FROM TblTariffLadder t")})
public class TblTariffLadder implements Serializable {
    ...
    public TblTariffLadder() {
    }

    public TblTariffLadder(Integer tariffLadderId) {
        this.tariffLadderId = tariffLadderId;
    }

    public TblTariffLadder(Integer tariffLadderId, long minNumTrans, long maxNumTrans) {
        this.tariffLadderId = tariffLadderId;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TblTariffLadder)) {
            return false;
        }
        TblTariffLadder other = (TblTariffLadder) object;
    ...
    public String toString() {
        return "com.napas.achoffline.authentication.models.TblTariffLadder[ tariffLadderId=" + tariffLadderId + " ]";
    }
