 ...
 */
@Entity
@Table(name = "TBL_TARIFF_PLAN")
@NamedQueries({
    @NamedQuery(name = "TblTariffPlan.findAll", query = "SELECT t FROM TblTariffPlan t")})
public class TblTariffPlan implements Serializable {
  ...
  //  @Size(min = 1, max = 20)
    ...
    public TblTariffPlan() {
    }

    public TblTariffPlan(Integer tariffPlanId) {
        this.tariffPlanId = tariffPlanId;
    }

    public TblTariffPlan(String planName, String planDescription, long ladderEnabledAmount, ReturnPaymentFeeType returnPaymentFeeType, Integer tariffPlanId, Date dateCreate, Date dateModified, String tariffPlanCode) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TblTariffPlan)) {
            return false;
        }
        TblTariffPlan other = (TblTariffPlan) object;
