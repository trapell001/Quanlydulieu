 ...
 */
@Entity
@Table(name = "TBL_TARIFF_DNS")
@NamedQueries({
        @NamedQuery(name = "TblTariffDNS.findAll", query = "SELECT t FROM TblTariffDNS t")})
public class TblTariffDNS implements Serializable {
    ...
    public int getTariffLadderId() {
        return tariffLadderId;
    }

    public void setTariffLadderId(int tariffLadderId) {
        this.tariffLadderId = tariffLadderId;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TblTariffDNS)) {
            return false;
        }
        TblTariffDNS other = (TblTariffDNS) object;
    ...
    public String toString() {
        return "com.napas.achoffline.authentication.models.TblTariffDNS[ tariffId=" + tariffId + " ]";
    }
