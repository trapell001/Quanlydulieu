...
@Entity
@Data
@Table(name = "TBL_SNAPSHOT_TARIFF")
@NamedQueries({
        @NamedQuery(name = "TblSnapshotTariff.findAll", query = "SELECT h FROM TblSnapshotTariff h")})
public class TblSnapshotTariff implements Serializable {
