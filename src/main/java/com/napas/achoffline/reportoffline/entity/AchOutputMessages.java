 ...
 */
@Entity
@Table(name = "OUTPUT_MESSAGES", schema="ACH")
@NamedQueries({
        @NamedQuery(name = "AchOutputMessages.findAll", query = "SELECT a FROM AchOutputMessages a")})
public class AchOutputMessages implements Serializable {
    ...
    public Character getFinality() {
        return finality;
    }

    public void setFinality(Character finality) {
