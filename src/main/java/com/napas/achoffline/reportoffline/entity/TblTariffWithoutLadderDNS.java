 ...
 */
@Entity
@Table(name = "TBL_TARIFF_WITHOUT_LADDER_DNS")
@NamedQueries({
        @NamedQuery(name = "TblTariffWithoutLadderDNS.findAll", query = "SELECT t FROM TblTariffWithoutLadderDNS t")})
public class TblTariffWithoutLadderDNS implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TblTariffWithoutLadderDNS)) {
            return false;
        }
        TblTariffWithoutLadderDNS other = (TblTariffWithoutLadderDNS) object;
    ...
    public String toString() {
        return "com.napas.achoffline.authentication.entity.TblTariffWithoutLadderDNS[ tariffId=" + tariffId + " ]";
    }
