 ...
 */
@Entity
@Table(name = "TBL_TARIFF")
@NamedQueries({
    @NamedQuery(name = "TblTariff.findAll", query = "SELECT t FROM TblTariff t")})
public class TblTariff implements Serializable {
  ...
  //  @Size(min = 1, max = 2)
   ...
   // @Size(max = 500)
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TblTariff)) {
            return false;
        }
        TblTariff other = (TblTariff) object;
    ...
    public String toString() {
        return "com.napas.achoffline.authentication.models.TblTariff[ tariffId=" + tariffId + " ]";
    }
