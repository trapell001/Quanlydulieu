 ...
 */
@Entity
@Table(name = "TBL_TARIFF_LADDER_DNS")
@NamedQueries({
        @NamedQuery(name = "TblTariffLadderDNS.findAll", query = "SELECT t FROM TblTariffLadderDNS t")})
public class TblTariffLadderDNS implements Serializable {
    ...
    public TblTariffLadderDNS() {
    }

    public TblTariffLadderDNS(Integer tariffLadderId) {
        this.tariffLadderId = tariffLadderId;
    }

    public TblTariffLadderDNS(Integer tariffLadderId, long minNumTrans, long maxNumTrans) {
        this.tariffLadderId = tariffLadderId;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TblTariffLadderDNS)) {
            return false;
        }
        TblTariffLadderDNS other = (TblTariffLadderDNS) object;
    ...
    public String toString() {
        return "com.napas.achoffline.authentication.models.TblTariffLadderDNS[ tariffLadderId=" + tariffLadderId + " ]";
    }
