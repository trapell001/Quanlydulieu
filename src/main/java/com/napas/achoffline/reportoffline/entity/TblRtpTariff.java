 ...
 */
@Entity
@Table(name = "TBL_RTP_TARIFF")
@NamedQueries({
        @NamedQuery(name = "TblRtpTariff.findAll", query = "SELECT t FROM TblRtpTariff t")})
public class TblRtpTariff implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TblRtpTariff)) {
            return false;
        }
        TblRtpTariff other = (TblRtpTariff) object;
    ...
    public String toString() {
        return "com.napas.achoffline.authentication.models.TblRtpTariff[ tariffId=" + tariffId + " ]";
    }
