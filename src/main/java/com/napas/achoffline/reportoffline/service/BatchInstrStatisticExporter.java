...
@Slf4j
public class BatchInstrStatisticExporter {
    private List<BatchInstrStatistic> listUsers;
    ...
    public BatchInstrStatisticExporter(List<BatchInstrStatistic> listUsers, String typeGroup) {
    ...
    private void writeHeaderLine() {
        ...
        sheet.setColumnWidth(columnCount++, 44*256);
...
//        style.setFont(font);
        ...
        int index = 1;
        for (BatchInstrStatistic user : listUsers) {
