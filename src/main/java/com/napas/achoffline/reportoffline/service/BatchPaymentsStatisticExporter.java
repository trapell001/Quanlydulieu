...
@Slf4j
public class BatchPaymentsStatisticExporter {
    private List<BatchPaymentsStatistic> listUsers;
    ...
    public BatchPaymentsStatisticExporter(List<BatchPaymentsStatistic> listUsers, String typeGroup) {
