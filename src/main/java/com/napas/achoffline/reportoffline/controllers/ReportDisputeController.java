...
import com.napas.achoffline.reportoffline.service.ReportDisputeService;
...
@RestController
@RequestMapping("/api/reportdispute")
public class ReportDisputeController {
    @Autowired
    private ReportDisputeService reportDisputeService;
    ...
    public void exportReport(HttpServletRequest request, HttpServletResponse response,
        ...
        reportDisputeService.generateReport(
                reportCode,
                filter,
                format,
                out);
    ...
    public List<ReportDisputeDefDTO> listAllReportOffline() {
        return reportDisputeService.listAllReportOffline();
    }
